<template>
  <div class="flex w-[1200px] flex-col mx-auto gap-[10px] my-[100px]">
    <h2 class="text-white text-[24px] font-noto font-bold mb-[30px]">Tecnologías</h2>

    <div class="flex flex-wrap gap-[20px] justify-center w-[800px] mx-auto mb-[100px]">
      <img
    ...
    <div class="flex justify-center flex-col gap-[10px] mx-auto">
      <img
        class="w-[300px]"
        src="https://github-readme-stats.vercel.app/api/top-langs?username=calvinuhh&show_icons=true&locale=en&layout=compact"
        alt="github_stats"
      />
      <p class="text-white font-noto">Tomado de las estadísticas de GitHub</p>
    </div>
  </div>
</template>
...
const techLogos = [

  {
    ...
    alt: "ts_logo",
    class: "w-[100px] h-[100px] transition-all duration-[0.2s] ease-out hover:scale-[1.3]"
  },
  {
  ...
  },
  {
    ...
    alt: "mongoose_logo",
    class: "w-[150px] h-[100px] transition-all duration-[0.2s] ease-out hover:scale-[1.3]"
  },
  {
    src: "https://1000marcas.net/wp-content/uploads/2020/11/MySQL-logo.png",
    alt: "mysql_logo",
    class: "w-[120px] h-[100px] transition-all duration-[0.2s] ease-out hover:scale-[1.3]"
  },
  {
  ...
  },
  {
    ...
    alt: "sequelize_logo",
    class: "w-[130px] h-[100px] transition-all duration-[0.2s] ease-out hover:scale-[1.3]"
  },
  {
    src: "https://res.cloudinary.com/deotitxt8/image/upload/v1733404612/portfolio/so51nrmeyaxtwby5cewo.png",
    alt: "jwt_logo",
    class: "w-[180px] h-[100px] transition-all duration-[0.2s] ease-out hover:scale-[1.3]"
  },
  {
